...
## Colunas definidas:
```
region,type,month,notified,confirmed,discarded,under_analysis,dengue_cases,dengue_alarm_cases,dengue_severe_cases,zika_cases,chikungunya_cases,deaths
```

**Descrição dos campos:**
- region (string): nome da região — "Norte", "Sul", "Leste", "Oeste", "Central", "Rural"
- type (string): "urban" ou "rural"
- month (string): boletim mensal — ex: "01/2026"
- notified (int)
- confirmed (int)
- discarded (int)
- under_analysis (int)
